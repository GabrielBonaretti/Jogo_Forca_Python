...
def menu(escolha_dificuldade_param):
    '''
    Essa função tem como objetivo printar o menu a partir da dificuldade escolhida pelo usuário.
    Caso ele não tenha digitado pela lógica o menu principal será printado.
    :param escolha_dificuldade_param: escolha da dificuldade.
    :return: print do menu.
    '''
...
def tratando_erro_menu(escolha_menu=0):
    '''
    Mostra a escolha dos menus, e trata o erro do menu caso alguem digite algo diferente de int.
    :param escolha_menu: escolha do menu
    :return: a opção escolhida pelo jogador de qualquer menu, e caso de erro.
    '''
    while True:
        menu(escolha_menu)
        try:
...
def facil(escolha_dificuldade_param):
    '''
    Dificuldade facil do jogo da forca, no qual puxa as funcoes de "inicio_de_jogo" ou
    "mostrar_lista" a apartir do retorno da função "tratando_erro_menu" do menu da dificuldade
    fácil.
    :param escolha_dificuldade_param: retorno da funcao "tratando_erro_menu", do menu principal
    ...
    while True:
        escolha_media = tratando_erro_menu(escolha_menu=escolha_dificuldade_param)
        os.system('cls')
        print("-" * 30)
...
def medio(escolha_dificuldade_param):
    '''
    Dificuldade médiado jogo da forca, no qual puxa as funções de "acrescentar_lista", "remover_lista",
    "inicio_de_jogo" ou "mostrar_lista" a apartir do retorno da função "tratando_erro_menu" do menu da dificuldade
    média.
    :param escolha_dificuldade_param: retorno da funcao "tratando_erro_menu", do menu principal
...
def dificil(escolha_dificuldade_param):
    '''
    Dificuldade dificil do jogo da forca, no qual primeiramente puxa a função "puxando_csv". E após isso a partir do
    retorno da função "tratando_erro_menu" do menu da dificuldade média pode chamar as funções de escrever_csv",
